    ...
    struct EThread15063
    {
        ...
        union
        {
            ...
            struct
            {
                ...
                UINT32 ReservedCrossThreadFlags : 10;
            };
        };
        union
        {
        ...
        ListEntry OwnerEntryListHead;
        UINT64 DisownedOwnerEntryListLock;
        ListEntry DisownedOwnerEntryListHead;
    };
#ifdef _WIN64
    static_assert(0x810 == sizeof(EThread15063), "EThread15063 Aligned error!");
#endif
