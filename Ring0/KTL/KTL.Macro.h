...
// __unaligned
#ifndef KTL$CompileTime$Unaligned$Macro
#ifdef _WIN64
#define KTL$CompileTime$Unaligned$Macro __unaligned
#else
#define KTL$CompileTime$Unaligned$Macro 
#endif
#endif
...
char(*KTL$CompileTime$NumberOf$Function(KTL$CompileTime$Unaligned$Macro T(&)[N]))[N];
